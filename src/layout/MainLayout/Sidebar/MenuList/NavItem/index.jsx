...
const NavItem = ({ item, level, navType, onClick, onUploadFile, drawerOpen }) => {
    ...
    return (
        <Tooltip title={!drawerOpen ? item.title : ''} placement='right' disableHoverListener={drawerOpen}>
            <ListItemButton
                {...listItemProps}
            ...
            >
                ...
                {drawerOpen && (
                    <ListItemText
                        primary={
                            <Typography variant={isSelected ? 'h5' : 'body1'} color='inherit' sx={{ my: 0.5 }}>
                                {item.title}
                            </Typography>
                        }
                        secondary={
                        ...
                        sx={{ my: 'auto', textAlign: 'right', marginRight: '1rem' }}
                    />
                )}
...
NavItem.propTypes = {
    ...
    drawerOpen: PropTypes.bool // <-- Add this
}
