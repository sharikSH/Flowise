...
const WorkspaceSwitcher = () => {
    ...
    useEffect(() => {
        if (switchWorkspaceApi.error) {
            ...
            setErrorMessage(switchWorkspaceApi.error.message || 'خطا در تغییر فضای کاری')
    ...
    return (
        <>
            ...
            !(assignedWorkspaces.length === 1 && user.activeWorkspace === 'فضای کاری پیش‌فرض') ? (
                <>
                    <Button
                        sx={{ mr: 4 }}
            ...
            >
                <DialogContent>
                    <Stack spacing={3}>
                        <Typography variant='h5'>فضای کاری در دسترس نیست</Typography>
                        <Typography variant='body1'>
                            فضای کاری کنونی شما دیگر در دسترس نیست. لطفاً فضای کاری دیگری را برای ادامه انتخاب کنید.
                        </Typography>
                        <Select
                            fullWidth
                            value=''
            ...
            >
                <DialogContent>
                    <Stack spacing={3}>
                        <Typography variant='h5'>خطا در تغییر فضای کاری</Typography>
                        <Typography variant='body1'>{errorMessage}</Typography>
                        {isEnterpriseLicensed && (
                            <Typography variant='body2' color='text.secondary'>
                                لطفاً برای دریافت کمک با مدیر خود تماس بگیرید.
                            </Typography>
                        )}
                    </Stack>
                </DialogContent>
