    ...
    return (
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mt: 2 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                <Typography variant='body2'>آیتم‌ها در هر صفحه:</Typography>
                <FormControl
                    variant='outlined'
                    size='small'
                    sx={{
            ...
            {totalItems > 0 && (
                <Typography variant='body2'>
                    {`آیتم‌های ${activePage * itemsPerPage - itemsPerPage + 1} تا ${
                        activePage * itemsPerPage > totalItems ? totalItems : activePage * itemsPerPage
                    } از مجموع ${totalItems}`}
                </Typography>
            )}
