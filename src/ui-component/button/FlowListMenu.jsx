...
export default function FlowListMenu({ chatflow, isAgentCanvas, isAgentflowV2, setError, updateFlowsApi }) {
    ...
    const title = isAgentCanvas ? 'عامل‌ها' : 'جریان گفتگو'
    ...
    const handleFlowStarterPrompts = () => {
        ...
        setConversationStartersDialogProps({
            title: 'پیام‌های آغازین - ' + chatflow.name,
            chatflow: chatflow
        })
    ...
    const handleFlowChatFeedback = () => {
        ...
        setChatFeedbackDialogProps({
            title: 'بازخورد گفتگو - ' + chatflow.name,
            chatflow: chatflow
        })
    ...
    const handleAllowedDomains = () => {
        ...
        setAllowedDomainsDialogProps({
            title: 'دامنه‌های مجاز - ' + chatflow.name,
            chatflow: chatflow
        })
    ...
    const handleSpeechToText = () => {
        ...
        setSpeechToTextDialogProps({
            title: 'گفتار به متن - ' + chatflow.name,
            chatflow: chatflow
        })
    ...
    const handleDelete = async () => {
        ...
        const confirmPayload = {
            title: `حذف`,
            description: `حذف ${title} ${chatflow.name}؟`,
    ...
    return (
        <div>
            ...
            <SaveChatflowDialog
                show={flowDialogOpen}
                dialogProps={{
                    title: `تغییر نام ${title}`,
                    confirmButtonName: 'تغییر نام',
                    cancelButtonName: 'لغو'
                }}
