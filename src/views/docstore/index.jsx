            ...
            {error ? (
                ...
                <Stack flexDirection='column' sx={{ gap: 3 }}>
                    <ViewHeader
                        ...
                        search={hasDocStores}
                        searchPlaceholder='جستجوی نام یا توضیحات'
                        title='مخزن اسناد'
                        description='ذخیره و به‌روزرسانی اسناد برای بازیابی مدل‌های زبانی بزرگ (RAG)'
                    >
                        {hasDocStores && (
                            <ToggleButtonGroup
                        ...
                        <Stack sx={{ alignItems: 'center', justifyContent: 'center' }} flexDirection='column'>
                            <Box sx={{ p: 2, height: 'auto' }}>
                                <img
                                    ...
                                    src={doc_store_empty}
                                    alt='تصویر خالی مخزن اسناد'
                                />
                            </Box>
                            <div>هنوز هیچ مخزن اسنادی ایجاد نشده است</div>
                        </Stack>
                    ) : (
                        <React.Fragment>
                            {!view || view === 'card' ? (
