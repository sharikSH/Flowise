...
const CanvasHeader = ({ chatflow, isAgentCanvas, isAgentflowV2, handleSaveFlow, handleDeleteFlow, handleLoadFlow }) => {
    ...
    const title = isAgentCanvas ? 'نمایندگان' : 'جریان گفتگو'
    ...
    const onSettingsItemClick = (setting) => {
        ...
        if (setting === 'deleteChatflow') {
            ...
            if (canvas.isDirty) {
                enqueueSnackbar({
                    message: 'لطفاً قبل از صادر کردن به عنوان قالب، جریان را ذخیره کنید',
                    options: {
            ...
            setUpsertHistoryDialogProps({
                title: 'مشاهده تاریخچه به‌روزرسانی',
                chatflow: chatflow
            })
    ...
    const onAPIDialogClick = () => {
        ...
        setAPIDialogProps({
            title: 'جاسازی در وب‌سایت یا استفاده به عنوان API',
        ...
        <>
            <Stack flexDirection='row' justifyContent='space-between' sx={{ width: '100%' }}>
                <Stack flexDirection='row' sx={{ width: '100%', maxWidth: '50%' }}>
                    <Box>
                        <ButtonBase title='بازگشت' sx={{ borderRadius: '50%' }}>
                            <Avatar
                                variant='rounded'
                                sx={{
                    ...
                    <Box sx={{ width: '100%' }}>
                        {!isEditingFlowName ? (
                            <Stack flexDirection='row'>
                                ...
                                {chatflow?.id && (
                                    <Available permission={savePermission}>
                                        <ButtonBase title='ویرایش نام' sx={{ borderRadius: '50%' }}>
                                            <Avatar
                                                variant='rounded'
                                                sx={{
                                                    ...theme.typography.commonAvatar,
                            ...
                            <Stack flexDirection='row' sx={{ width: '100%' }}>
                                ...
                                />
                                <ButtonBase title='ذخیره نام' sx={{ borderRadius: '50%' }}>
                                    <Avatar
                                        variant='rounded'
                                        sx={{
                                            ...theme.typography.commonAvatar,
                                ...
                                <ButtonBase title='لغو' sx={{ borderRadius: '50%' }}>
                                    <Avatar
                                        variant='rounded'
                                        sx={{
                                            ...theme.typography.commonAvatar,
                ...
                <Box>
                    {chatflow?.id && (
                        <ButtonBase title='نقطه پایانی API' sx={{ borderRadius: '50%', mr: 2 }}>
                            <Avatar
                                variant='rounded'
                                sx={{
                                    ...theme.typography.commonAvatar,
                    ...
                    <Available permission={savePermission}>
                        <ButtonBase title={`ذخیره ${title}`} sx={{ borderRadius: '50%', mr: 2 }}>
                            <Avatar
                                variant='rounded'
                                sx={{
                                    ...theme.typography.commonAvatar,
                    ...
                    <ButtonBase ref={settingsRef} title='تنظیمات' sx={{ borderRadius: '50%' }}>
                        <Avatar
                            variant='rounded'
                            sx={{
                                ...theme.typography.commonAvatar,
