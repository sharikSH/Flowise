        ...
        <>
            <TableRow sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                ...
                <StyledTableCell style={{ width: '40%' }}>
                    ...
                    <IconButton title='کپی' color='success' onClick={props.onCopyClick}>
                        <IconCopy />
                    </IconButton>
                    <IconButton
                        title={props.showApiKeys.includes(props.apiKey.apiKey) ? 'مخفی کردن' : 'نمایش'}
                        color='inherit'
                ...
                <StyledTableCell>
                    ...
                    {props.apiKey.chatFlows.length > 0 && (
                        <IconButton aria-label='باز کردن ردیف' size='small' color='inherit' onClick={() => setOpen(!open)}>
                ...
                <Available permission={'apikeys:update,apikeys:create'}>
                    <StyledTableCell>
                        <IconButton title='ویرایش' color='primary' onClick={props.onEditClick}>
                            <IconEdit />
                        </IconButton>
                    </StyledTableCell>
                </Available>
                <Available permission={'apikeys:delete'}>
                    <StyledTableCell>
                        <IconButton title='حذف' color='error' onClick={props.onDeleteClick}>
                            <IconTrash />
                        </IconButton>
                    </StyledTableCell>
                </Available>
                    ...
                    <StyledTableCell sx={{ p: 2 }} colSpan={6}>
                        <Collapse in={open} timeout='auto' unmountOnExit>
                            <Box sx={{ borderRadius: 2, border: 1, borderColor: theme.palette.grey[900] + 25, overflow: 'hidden' }}>
                                <Table aria-label='جدول جریان‌های گفت‌وگو'>
                                    <TableHead sx={{ height: 48 }}>
                                        <TableRow>
                                            <StyledTableCell sx={{ width: '30%' }}>نام جریان گفت‌وگو</StyledTableCell>
                                            <StyledTableCell sx={{ width: '20%' }}>تغییر یافته در</StyledTableCell>
                                            <StyledTableCell sx={{ width: '50%' }}>دسته‌بندی</StyledTableCell>
                                        </TableRow>
                                    </TableHead>
                                    <TableBody>
        ...
        const confirmPayload = {
            ...
            description:
                key.chatFlows.length === 0
                    ? `حذف کلید [${key.keyName}]؟`
                    : `حذف کلید [${key.keyName}]؟\n ${key.chatFlows.length} جریان گفت‌وگو از این کلید استفاده می‌کنند.`,
                ...
                {error ? (
                    ...
                    <Stack flexDirection='column' sx={{ gap: 3 }}>
                        <ViewHeader
                            ...
                            search={true}
                            searchPlaceholder='جستجوی نام کلید'
                            title='کلیدهای API'
                            description='کلیدهای احراز هویت API و SDK فلوایز'
                        >
                            <PermissionButton
                            ...
                            <Stack sx={{ alignItems: 'center', justifyContent: 'center' }} flexDirection='column'>
                                <Box sx={{ p: 2, height: 'auto' }}>
                                    <img
                                        ...
                                        src={APIEmptySVG}
                                        alt='عدم وجود کلید API'
                                    />
                                </Box>
                                <div>هنوز کلید API وجود ندارد</div>
                            </Stack>
                        ) : (
                            <>
                                <TableContainer
                                ...
                                >
                                    <Table sx={{ minWidth: 650 }} aria-label='جدول ساده'>
                                        ...
                                        >
                                            <TableRow>
                                                <StyledTableCell>نام کلید</StyledTableCell>
                                                <StyledTableCell>کلید API</StyledTableCell>
                                                <StyledTableCell>میزان استفاده</StyledTableCell>
                                                <StyledTableCell>ایجاد شده در</StyledTableCell>
                                                <Available permission={'apikeys:update,apikeys:create'}>
