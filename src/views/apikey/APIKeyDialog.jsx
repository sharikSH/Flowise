...
const APIKeyDialog = ({ show, dialogProps, onCancel, onConfirm, setError }) => {
    ...
    const addNewKey = async () => {
        try {
            ...
            enqueueSnackbar({
                message: `خطا در افزودن کلید API جدید: ${
        ...
        >
            ...
            <DialogContent>
                {dialogProps.type === 'EDIT' && (
                    <Box sx={{ p: 2 }}>
                        <Typography variant='overline'>کلید API</Typography>
                ...
                <Box sx={{ p: 2 }}>
                    <Stack sx={{ position: 'relative' }} direction='row'>
                        <Typography variant='overline'>نام کلید</Typography>
                    </Stack>
                    <OutlinedInput
                        id='keyName'
                        type='string'
                        fullWidth
                        placeholder='کلید جدید من'
                        value={keyName}
                        name='keyName'
