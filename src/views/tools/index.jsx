...
const Tools = () => {
    ...
    const [view, setView] = useState(localStorage.getItem('toolsDisplayStyle') || 'کارت')
                ...
                {error ? (
                    ...
                    <Stack flexDirection='column' sx={{ gap: 3 }}>
                        <ViewHeader
                            ...
                            title='ابزارها'
                            description='توابع خارجی یا APIهایی که عامل می‌تواند برای انجام کارها استفاده کند'
                        >
                            <ToggleButtonGroup
                            ...
                            <ButtonGroup disableElevation aria-label='گروه دکمه‌های اولیه خطی'>
                            ...
                            <Stack sx={{ alignItems: 'center', justifyContent: 'center' }} flexDirection='column'>
                                <Box sx={{ p: 2, height: 'auto' }}>
                                    <img
                                        ...
                                        src={ToolEmptySVG}
                                        alt='تصویر خالی ابزار'
                                    />
                                </Box>
                                <div>هنوز هیچ ابزاری ایجاد نشده است</div>
                            </Stack>
                        )}
                    </Stack>
                )}
